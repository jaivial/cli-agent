...
export default function CentroLapaPage() {
    ...
    >
      ...
      <div className="route-page">
        ...
        <motion.section className="route-section" variants={itemVariants}>
          ...
          <InteractiveMap 
            markers={[
              { position: [-22.9070, -43.1888], title: 'Lapa', color: route.color },
              { position: [-22.9090, -43.1830], title: 'Cinelândia', color: '#00b36b' },
              { position: [-22.9025, -43.1805], title: 'Praça XV', color: '#00b36b' },
            ]}
          />
        </motion.section>
        ...
        <motion.section className="route-nav" variants={itemVariants}>
          <Link to="/carnival/orla" className="route-nav-btn next">
            <span>{t('routePage.next')}: Orla</span>

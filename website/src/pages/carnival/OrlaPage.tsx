    ...
    >
      ...
      <div className="route-page">
        ...
        <motion.section className="route-section" variants={itemVariants}>
          ...
          <InteractiveMap 
            markers={[
              { position: [-22.9711, -43.1822], title: 'Copacabana', color: route.color },
              { position: [-22.9838, -43.2096], title: 'Ipanema', color: route.color },
              { position: [-22.9904, -43.2156], title: 'Leblon', color: route.color },
            ]}
          />
        </motion.section>
        ...
        <motion.section className="route-nav" variants={itemVariants}>
          <Link to="/carnival/schedule" className="route-nav-btn next">
            <span>{t('routePage.viewSchedule')}</span>
